...
if len(competitor_spend_analysis) > 0 and len(deep_dive_competitors) > 0:
    for comp_name in deep_dive_competitors:
        ...
        # Audit 2026-04-17: y-axis labels were positional "Account 1..N",
        # which made the chart unactionable -- CSMs could see "20 at-risk
        # accounts" but not which ones. primary_account_num is the real
        # identifier carried through from 20_spend_segmentation.
        ax.set_yticklabels(
            [f"#{a}" for a in top_n['primary_account_num']],
