...
if 'cohort_df' not in dir() or len(cohort_df) == 0:
    print("    No merchant cohort data available. Skipping lifecycle chart.")
else:
    ...
    # Subtitle previously listed only 3 of the 4 plotted series ("new
    # entrants, continuing partners, and merchant attrition") -- audit
    # flagged it as a label QA issue. "Returning" was visibly plotted
    # but never described.
    ax.text(0.0, 1.02,
